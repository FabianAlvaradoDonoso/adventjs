const prepareGifts = require('./main.js')

test('Test #01 - Returns type', () => {
  expect(typeof prepareGifts([1])).toBe('array')
})

test('Test #02 - prepareGifts([3, 1, 2, 3, 4, 2, 5])', () => {
  expect(prepareGifts([3, 1, 2, 3, 4, 2, 5])).toStrictEqual([1, 2, 3, 4, 5])
})
...
test('Test #07 - prepareGifts([3, 1, 2, 3, 1, 2])', () => {
  expect(prepareGifts([3, 1, 2, 3, 1, 2])).toStrictEqual([1, 2, 3])
})
